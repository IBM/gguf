...
## Build Details
- **llama.cpp Version**: b9704
- **Build Date**: 2026-07-17 20:02:32 UTC
- **Platform**: Linux (linux-x86_64)
- **Architecture**: x86_64 (Intel/AMD 64-bit)
- **Minimum OS Version**: N/A (portable Linux binary)

## Input Parameters
- **llama_cpp_version**: `b9704`
...
---
Built with GitHub Actions workflow: https://github.com/ibm-granite/gguf/actions/runs/29609322399
