...
- **Build Date**: 2026-04-15 18:06:26 UTC
...
- **Note**: Metal shaders are NOT embedded (GGML_METAL_EMBED_LIBRARY not used due to cross-compilation issues)
- **Result**: GPU-accelerated binaries with runtime Metal shader compilation
...
## Usage
All binaries are statically linked and GPU-accelerated for Apple Silicon. Metal acceleration is automatically detected at runtime - uses GPU on M1/M2/M3/M4, falls back to CPU on other platforms. Requires .metal shader files to be present at runtime.

## Build Configuration Summary
- Cross-compiled from x86_64 macOS to ARM64 target
- Metal GPU acceleration enabled (shaders compiled at runtime, not embedded)
...
- Note: Requires .metal files for GPU acceleration (not self-contained)

---
Built with GitHub Actions workflow: https://github.com/IBM/gguf/actions/runs/24470008951
