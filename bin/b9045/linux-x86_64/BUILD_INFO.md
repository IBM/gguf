...
## Build Details
- **llama.cpp Version**: b9045
- **Build Date**: 2026-07-21 19:51:55 UTC
- **Platform**: Linux (linux-x86_64)
- **Architecture**: x86_64 (Intel/AMD 64-bit)
- **Minimum OS Version**: N/A (portable Linux binary)

## Input Parameters
- **llama_cpp_version**: `b9045`
...
---
Built with GitHub Actions workflow: https://github.com/ibm-granite/gguf/actions/runs/29862842895
